...
// pixelArt.ts: acerca la paleta generada de una foto a estos colores para
// que un avatar nuevo conviva visualmente con los 48 de AVATARS.
export const ARCADE_ACCENT_RGB: RGB[] = [
...
// puntual (ej. domain/exportPdf.ts) en vez de recorrer la lista completa.
export const ARCADE_COLORS: Record<string, RGB> = {
