import type { Phase, TimedPhase, CardColumn } from "./types.js";
...
export const PHASE_THEMES: Record<Phase, PhaseTheme> = {
  waiting_room: {
...
export const DEFAULT_DURATIONS_MINUTES: Record<TimedPhase, number> = {
  welcome: 3,
  previous_action: 5,
  keep_improve_try: 15,
  grouping_voting: 10,
...
export const TIMEBOXING_NOTES: Record<TimedPhase, string> = {
...
export const CARD_COLUMNS_BY_PHASE: Partial<Record<Phase, CardColumn[]>> = {
...
export const COLUMN_PROMPTS: Record<"keep" | "improve" | "try", string[]> = {
  keep: [
...
// Debe coincidir con TEAM_NAME_MAX_LENGTH en back/src/domain/room.ts.
