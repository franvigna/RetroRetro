...
// tarjeta cuando se vota/desvota (ver FlyingStar.tsx).
export const StarsHeader = forwardRef<HTMLDivElement, StarsHeaderProps>(function StarsHeader({ total, remaining }, ref) {
