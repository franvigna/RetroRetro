...
import type { Card, CardColumn } from "../domain/types.js";
import type { ParticipantsById } from "./CardColumn.tsx";

const COLUMN_PILL_LABELS: Partial<Record<CardColumn, string>> = {
  keep: "Keep",
  improve: "Improve",
  try: "Try",
};
...
// domain/topVotedCards.ts, espeja el algoritmo del backend). Sin formulario
...
export function HallOfFame({ cards, participantsById }: HallOfFameProps) {
