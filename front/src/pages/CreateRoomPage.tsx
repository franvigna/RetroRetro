...
import { PhaseDurationInput } from "../components/PhaseDurationInput.tsx";
import { StarsSliderInput } from "../components/StarsSliderInput.tsx";
...
import type { TimedPhase } from "../domain/types.js";
...
export function CreateRoomPage() {
  ...
  const [durations, setDurations] = useState<Record<TimedPhase, number>>(() => ({ ...DEFAULT_DURATIONS_MINUTES }));
  ...
  function handleSubmit(e: React.FormEvent) {
    ...
    ) as Partial<Record<TimedPhase, number>>;
    createRoom({
