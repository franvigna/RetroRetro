...
import { CardColumn } from "../components/CardColumn.tsx";
import { StarsHeader } from "../components/StarsHeader.tsx";
import { FlyingStar } from "../components/FlyingStar.tsx";
import { SpeakerList } from "../components/SpeakerList.tsx";
import { HallOfFame } from "../components/HallOfFame.tsx";
import { TimerFinishedBanner } from "../components/TimerFinishedBanner.tsx";
import { SpeakerRotationWarning } from "../components/SpeakerRotationWarning.tsx";
import { PreviousActionPanel } from "../components/PreviousActionPanel.tsx";
...
export function ActivePhasePage() {
  ...
  const starsHeaderRef = useRef<HTMLDivElement>(null);
  const [flyingStar, setFlyingStar] = useState<FlyingStarState | null>(null);
  ...
  const handleVote = useCallback(
    (cardId: string, buttonEl: HTMLButtonElement, alreadyVoted: boolean) => {
            ...
            <div className="card-columns">
              {columnsToShow.map((column) => (
                <CardColumn
                  ...
                  participants={room.participants}
                  canAddCard={!showsPastCards && Boolean(columnsForPhase?.includes(column))}
