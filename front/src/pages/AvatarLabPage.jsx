...
import { PixelArtControls } from "../components/PixelArtControls.jsx";
import { AvatarExportPanel } from "../components/AvatarExportPanel.jsx";
...
// Herramienta interna (ruta /dev/avatar-lab, ver App.jsx) para generar
// avatares pixel-art (GRID_SIZE x GRID_SIZE, ver pixelArt.js) a partir de
// una foto, sin depender de ningún servicio de pago: todo el pipeline
// corre en el navegador (ver useAvatarLab.js). No
// escribe en avatars.js — el resultado se descarga y se pega a mano, igual
...
export function AvatarLabPage() {
  ...
  function handleImageReady({ bitmap }) {
    setDropError(null);
    run(bitmap);
  }
